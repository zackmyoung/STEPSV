...
----------------------------------------------------------------------
HARDWARE AND SOFTWARE ENVIRONMENT USED FOR THE STUDY
----------------------------------------------------------------------

The analyses reported in Young et al. were performed on a local
workstation/server with:

  CPU:
    2 × AMD EPYC 9654 processors
    96 cores per processor, 192 physical CPU cores total

  GPU:
    2 × NVIDIA RTX 6000 Ada Generation GPUs
    48 GB GDDR6 memory per GPU
